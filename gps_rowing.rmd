...
This map shows the tracks on the water (red lines). The maps comes from openstreetmap.org.
...
ggplot(wohlensee_sf, fill = NA) +
  geom_sf() +
  ggsn::blank() +
  geom_line(data = gps_data_1, aes(x = gps_lon, y = gps_lat), color = "red", size = 0.1)
